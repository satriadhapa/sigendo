<!-- resources/views/create_program_studi.blade.php -->
<x-app-layout>
                ...
                <div class="flex bg-gray-300 shadow-sm rounded-lg overflow-hidden">
                    ...
                    <div class="flex-1 p-6 bg-gray-300">
                        ...
                        <div class="welcome-container text-center text-3xl font-bold">
                            <h1 class="welcome-heading">{{ __("Tambah Program Studi") }}</h1>
                        </div>

                        <!-- Form for Adding Program Studi -->
                        <form action="{{ route('admin.programstudi.store') }}" method="POST">
                            ...
                            <div class="space-y-4">
                                <div class="flex flex-col">
                                    ...
                                    <input type="text" name="kode" id="kode" class="p-2 border border-gray-400 rounded" required>
                                </div>
                                <div class="flex flex-col">
                                    <label for="name" class="text-lg font-semibold text-gray-700">Nama Program Studi</label>
                                    <input type="text" name="name" id="name" class="p-2 border border-gray-400 rounded" required>
                                </div>
                            </div>
                            <div class="flex justify-end space-x-4 mt-6">
                                <a href="{{ route('admin.programstudi') }}" class="bg-gray-300 text-gray-800 font-semibold py-2 px-4 rounded">Cancel</a>
                                <button type="submit" class="bg-pink-800 hover:bg-pink-900 text-white font-bold py-2 px-4 rounded">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
