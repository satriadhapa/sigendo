<!-- resources/views/create_matakuliah.blade.php -->
<x-app-layout>
                        ...
                        <div class="bg-white shadow-sm rounded-lg p-6">
                            ...
                            <form action="{{ route('admin.matakuliah.store') }}" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="sks" id="sks" class="w-full border border-gray-300 rounded-lg px-4 py-2" required>
                                </div>

                                <!-- Mata Kuliah Code Field -->
                                <div class="mb-4">
                                    <label class="block text-gray-700 font-semibold mb-2" for="kode">Kode Mata Kuliah</label>
                                    <input type="text" name="kode" id="kode" class="w-full border border-gray-300 rounded-lg px-4 py-2" required>
                                </div>
