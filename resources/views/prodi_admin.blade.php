            ...
            <div class="max-w-9xl mx-auto sm:px-6 lg:px-8">
                <div class="flex bg-gray-300 shadow-sm rounded-lg overflow-hidden">
                    ...
                    <div class="flex-1 p-6 bg-gray-300">
                        ...
                        <!-- Add Data Button -->
                        <div class="mb-4">
                            <a href="{{ route('admin.programstudi.create') }}" class="bg-pink-800 text-white font-semibold py-2 px-4 rounded hover:bg-pink-900">
                                + Tambah Data
                            </a>
                        </div>
                            ...
                            <table class="min-w-full bg-white border border-gray-200 rounded-lg">
                                ...
                                <tbody>
                                    @foreach($programStudi as $index => $program)
                                        <tr class="border-b">
                                            <!-- Number Column -->
                                            <td class="py-2 px-4 text-center">{{ $programStudi->firstItem() + $index }}</td>
                                            <!-- Program Name Column -->
                        ...
                        <!-- Pagination Links -->
                        <div class="mt-6">
                            {{ $programStudi->links() }} <!-- Laravel's built-in pagination links -->
                        </div>
