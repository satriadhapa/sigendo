<!-- resources/views/create_jam_kuliah.blade.php -->
<x-app-layout>
                ...
                <div class="flex bg-gray-300 shadow-sm rounded-lg overflow-hidden">
                    ...
                    <div class="flex-1 p-6 bg-gray-300">
                        ...
                        <div class="welcome-container">
                            <h2 class="welcome-heading">{{ __("Tambah Jam Kuliah") }}</h2>
                        </div>

                        <!-- Add Lecture Hour Form -->
                        <div class="bg-white shadow-sm rounded-lg p-6">
                            <form action="{{ route('admin.jamkuliah.store') }}" method="POST">
                                @csrf

                                <!-- Start Time Field -->
                                <div class="mb-4">
                                    <label class="block text-gray-700 font-semibold mb-2" for="start_time">Waktu Mulai</label>
                                    <input type="time" name="start_time" id="start_time" class="w-full border border-gray-300 rounded-lg px-4 py-2" required>
                                </div>

                                <!-- End Time Field -->
                                <div class="mb-4">
                                    <label class="block text-gray-700 font-semibold mb-2" for="end_time">Waktu Selesai</label>
                                    <input type="time" name="end_time" id="end_time" class="w-full border border-gray-300 rounded-lg px-4 py-2" required>
                                </div>
